...
![image-20210728100322410](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728100322410.png)

MVC
垂直应用架构：将应用切割成几个互不相干的小应用，在将每个小应用独立放到一个服务器上，如果哪一个应用的访问数量多就多加几台服务器。

![image-20210728100331836](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728100331836.png)

分布式服务架构

![image-20210728100341761](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728100341761.png)
...
![image-20210727102229323](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210727102229323.png)
...
https://blog.csdn.net/qq_41157588/article/details/106737191的快速开始

# dubbo-monitor-simple简易监控中心

1. 进入dubbo-monitor-simple文件，执行cmd命令，mvn package打包成jar包

2. 将 dubbo-monitor-simple-2.0.0-assembly.tar.gz 压缩包解压至当前文件夹，解压后config文件查看properties的配置是否是本地的zookeeper。
...
![image-20210728101219191](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728101219191.png)
...
![image-20210728102034491](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728102034491.png)
...
![image-20210728100411900](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728100411900.png)
...
![image-20210728103947934](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728103947934.png)

**NIO (Non-Blocking IO)**

![image-20210728103957148](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728103957148.png)
...
![image-20210728104021320](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728104021320.png)
netty基本原理，可参考https://www.sohu.com/a/272879207_463994

# dubbo原理 -框架设计

![image-20210728224626626](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728224626626.png)

# dubbo原理 -启动解析、加载配置信息

![image-20210728225244876](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728225244876.png)

# dubbo原理 -服务暴露

![image-20210728225300292](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728225300292.png)

# dubbo原理 -服务引用

![image-20210728225321671](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728225321671.png)

# dubbo原理 -服务调用

![image-20210728225347136](F:\Typora数据储存\分布式系统\dubbo.assets\image-20210728225347136.png)
